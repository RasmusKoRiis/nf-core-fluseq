...
required_columns = [
    ...
    "DR_Res_Peramivir",
    "DR_Res_Zanamivir",
    "HA1 Differences human",
    "HA1 Differences human_vaccine",
    "HA2 Differences human",
    "HA2 Differences human_vaccine",
    "IRMA_altmatch",
    "IRMA_chimeric",
    "IRMA_failQC",
    "IRMA_initial",
    ...
    "IRMA_nomatch",
    "IRMA_passQC",
    "M1 Differences human",
    "M2 Differences human",
    "M2 Differences inhibition_human",
    "M2 inhibtion mutations",
    "NA Differences human",
    "NA Differences human_vaccine",
    "NA Differences inhibition_human",
    "NA inhibtion mutations",
    "NP Differences human",
    "NS1 Differences human",
    "Nextclade QC HA1",
    "Nextclade QC M1",
    "Nextclade QC NA",
    "Nextclade QC NP",
    ...
    "Nextclade QC PB1",
    "Nextclade QC PB2",
    "PA Differences human",
    "PA Differences inhibition_human",
    "PA inhibtion mutations",
    "PB1 Differences human",
    "PB2 Differences human",
    "SigPep Differences human",
    "Subtype",
    "aaDeletions HA1",
    "aaDeletions M1",
    "aaDeletions M2",
...
merged_data["DR_M2_Mut"] = np.where(
    ...
    "NA",
    np.where(merged_data["DR_Res_Adamantine"].eq("Review"), merged_data["M2 inhibtion mutations"], "No Mutations"),
)
...
merged_data["DR_PA_Mut"] = np.where(
    ...
    "NA",
    np.where(merged_data["DR_Res_Baloxavir"].eq("Review"), merged_data["PA inhibtion mutations"], "No Mutations"),
)
...
merged_data["IRMA_noise"] = pd.to_numeric(
    merged_data.get("IRMA_noise", pd.Series(index=merged_data.index)), errors="coerce"
).round(5)
